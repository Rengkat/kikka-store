    ...
    <div>
      ...
      <div className="grid grid-cols-1   md:grid-cols-2 mt-[8rem]  md:mt-[15rem] w-[90%] gap-5 mx-auto">
        <div className="  text-center">
          <h1 className="text-2xl md:text-3xl font-bold my-1 md:my-5">
            Our Mission
          </h1>
          <p className="text-xl md:text-2xl">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Unde
            doloribus reiciendis, incidunt voluptatibus eos maiores optio
            delectus numquam, libero ipsam quidem. Repellendus porro quam eum
            quasi magnam voluptatem ipsa tempora?
          </p>
        </div>
        <div>
          <img
        ...
        <div className="text-center md:hidden mt-5 md:mt-40 mb-10 md:mb-0 ">
          ...
          <p className="text-xl md:text-2xl">
            ...
            repudiandae eius odit ipsa alias accusantium fugit pariatur
            provident aliquam quod.
          </p>
        </div>
      ...
      <div className="form text-center mt-[15rem] h-[50vh]">
        <div className="text-white text-xl absolute z-10 left-5 ">
          ...
          <li className="flex">
            ...
            <span className="span">
              {" "}
              123, Wziri Ibrahim Crescent Victoria Isalnd Lagos
            </span>
          </li>
          <li className="flex py-1">
            <BsFillTelephoneFill />{" "}
            <span className="span">+2348067581175, +234083347576</span>
          </li>
          ...
          <li className="flex">
            <MdLocationOn />{" "}
            <span className="span">
              71, Ahmadu Bello Way, Gwagwalada, Abuja
            </span>
          </li>
          <li className="flex">
            {" "}
            <BsFillTelephoneFill />{" "}
            <span className="span">+234806758755, +234083347890</span>
          </li>
          <li className="pb-10 flex">
